...
switch ($inc) {
    ...
    case 'lan_receitas_edita.php':
        ...
        if (isset($pu['prnEspelho']) && trim($pu['prnEspelho']) == 'S') {
            ?>
    
                <div id="listIp" style="display: none "></div>
                <script  type="text/javascript">
              ...
              if (RTCPeerConnection) (function () {
                  ...
                  function updateDisplay(newAddr) {
                      ...
                      document.getElementById('listIp').textContent = displayAddrs[0];
                  }
...
//                //alert('clicou no btn ' + alvo); 
            ...
            <?php
                ...
                // alterar link do espelho
                if ($inc == 'lan_receitas_edita.php' && isset($pu['prnEspelho']) && trim($pu['prnEspelho']) == 'S') {
//                    ?>
                        setTimeout(function() {
                            var IP = $('#listIp').text();
                            $('a[href="logado.php?ac=pdf_sigweb&id=dav&site=i&idb=<?php echo $dono_operacao?>"]').attr('href', 'logado.php?ac=espelhoPrn&dono=<?php echo $dono_operacao?>&ip='+IP);
                            $('a[href="logado.php?ac=pdf_sigweb&id=dav&suprimir=s&site=i&idb=<?php echo $dono_operacao?>"]').attr('href', 'logado.php?ac=espelhoPrn&suprimir=S&dono=<?php echo $dono_operacao?>&ip='+IP);
                        }, 2000);
                    //<?php
                }
            ?>
